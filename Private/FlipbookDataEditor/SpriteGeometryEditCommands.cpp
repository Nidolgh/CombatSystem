...
void FFlipbookDataGeometryEditCommands::RegisterCommands()
{
	// Show toggles
	...
	UI_COMMAND(AddBoxShape, "Add Box", "DDDDDAdds a new box shape.", EUserInterfaceActionType::Button, FInputChord());
