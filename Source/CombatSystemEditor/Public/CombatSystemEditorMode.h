...
#include "CombatSystemEditorMode.generated.h"
 ...
 */
UCLASS()
class UCombatSystemEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_CombatSystemEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UCombatSystemEditorMode();
	virtual ~UCombatSystemEditorMode();
