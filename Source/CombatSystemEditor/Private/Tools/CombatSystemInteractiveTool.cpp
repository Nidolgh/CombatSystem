...
#include "CombatSystemInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UCombatSystemInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCombatSystemInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UCombatSystemInteractiveTool* NewTool = NewObject<UCombatSystemInteractiveTool>(SceneState.ToolManager);
...
UCombatSystemInteractiveToolProperties::UCombatSystemInteractiveToolProperties()
{
...
void UCombatSystemInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCombatSystemInteractiveTool::Setup()
{
	...
	Properties = NewObject<UCombatSystemInteractiveToolProperties>(this, "Measurement");
...
void UCombatSystemInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCombatSystemInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCombatSystemInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCombatSystemInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCombatSystemInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCombatSystemInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCombatSystemInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCombatSystemInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCombatSystemInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
