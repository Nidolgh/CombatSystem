...
#include "CombatSystemInteractiveTool.generated.h"


/**
 * Builder for UCombatSystemInteractiveTool
 */
UCLASS()
class COMBATSYSTEMEDITOR_API UCombatSystemInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UCombatSystemInteractiveTool
 */
UCLASS(Transient)
class COMBATSYSTEMEDITOR_API UCombatSystemInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCombatSystemInteractiveToolProperties();
...
/**
 * UCombatSystemInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class COMBATSYSTEMEDITOR_API UCombatSystemInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCombatSystemInteractiveToolProperties> Properties;
