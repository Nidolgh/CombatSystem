...
class SCombatFlipbookTimeline : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SCombatFlipbookTimeline)
		: _CombatFlipbookBeingEdited(nullptr)
		, _PlayTime(0)
	{}

	SLATE_ATTRIBUTE(class UCombatFlipbook*, CombatFlipbookBeingEdited)
...
private:
	...
	TAttribute<class UCombatFlipbook*> CombatFlipbookBeingEdited;
