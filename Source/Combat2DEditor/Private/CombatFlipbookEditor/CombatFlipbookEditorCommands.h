...
class FCombatFlipbookEditorCommands : public TCommands<FCombatFlipbookEditorCommands>
{
public:
	FCombatFlipbookEditorCommands()
		: TCommands<FCombatFlipbookEditorCommands>(
			TEXT("CombatFlipbookEditor"), // Context name for fast lookup
			NSLOCTEXT("Contexts", "CombatFlipbookEditor", "CombatFlipbook Editor"), // Localized context name for displaying
			NAME_None, // Parent
